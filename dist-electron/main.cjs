...
function requireMain() {
  ...
  (function(exports2) {
    ...
    var __exportStar = main$1 && main$1.__exportStar || function(m, exports3) {
...
const isDev = process.env.NODE_ENV === "development" || !require$$1$4.app.isPackaged;
const getRendererPath = () => {
  if (isDev) {
    return "http://localhost:4000";
  }
  return `file://${require$$1$1.join(__dirname, "..", "dist", "index.html")}`;
};
let mainWindow;
const createWindow = () => {
  ...
  if (isDev) {
    ...
    const rendererPath = require$$1$1.join(__dirname, "..", "dist", "index.html");
...
const createMenu = () => {
  ...
  const menu = require$$1$4.Menu.buildFromTemplate(template);
...
require$$1$4.ipcMain.handle("app-version", () => {
  return require$$1$4.app.getVersion();
});
require$$1$4.ipcMain.handle("check-for-updates", () => {
  mainExports.autoUpdater.checkForUpdatesAndNotify();
});
