...
interface EditCostDialogProps {
  ...
  onSubmit: (data: UpdateAdditionalCostFormData) => Promise<boolean>;
  loading?: boolean;
}
...
export function EditCostDialog({
  ...
  const form = useForm<UpdateAdditionalCostFormData>({
    resolver: zodResolver(updateAdditionalCostSchema),
    defaultValues: {
      id: cost.id,
  ...
  const handleSubmit = async (data: UpdateAdditionalCostFormData) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>Chỉnh sửa chi phí phát sinh</DialogTitle>
        </DialogHeader>
